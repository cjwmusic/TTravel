 ...
 */
public class TxSettingActivity extends BaseActivity{
    ...
    void doResetPwd(View v) {
        ...
        HttpClient.postLogin("Member/CashKeySet", getResetParams(username, smsCode, passwordConfirm), null, new HttpClient.HttpCallback<Object>() {
            @Override
            public void onSuccess(Object obj) {
                JSONObject data = (JSONObject) obj;
                showSuccess(data.getString("Message"));
