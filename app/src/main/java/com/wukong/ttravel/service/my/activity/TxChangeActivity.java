 ...
 */
public class TxChangeActivity extends BaseActivity {
    ...
    void loadData(String oldPw,String newPw) {
        ...
        HttpClient.post("Member/CashKeyModify", getParams(Helper.sharedHelper().getUserId(),oldPw,newPw), null, new HttpClient.HttpCallback<Object>() {
            @Override
