package com.wukong.ttravel.service.test;
 ...
 */
public class CanlendarTestActivity extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test_canlendar_activity);

        bt = (Button) findViewById(R.id.bt);
        bt.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                new PopupWindows(CanlendarTestActivity.this, bt);
            }
        });
